...
## An animated pyramid plot 
- Impact of job tenure based on Canada's economy 
 + Generally, when the economy is stable, the number of short-term jobs increase and workers transition periods happen accordingly
 + During the financial crises of 1989 - 1992 and 2008 - 2012, workers with shorter tenure are hit the hardest and those with longer tenure maintain their position 
    + This increase in tenure confirms that layoffs affect workers with lower seniority more compared to workers with higher seniority 
=======
...
## Job tenure by Year, Age and Gender
>>>>>>> 0e536a56ac305ddffec574f1cb70124d4f309408
